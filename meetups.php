	...
	<body>
		...
		<div>
			<?php
				...
				$sql = "SELECT id, event_owner, event_name, event_location, event_desc, event_date FROM eventTable ";
		...
		<div>
			...
			<form id="event_form">
				  Full name:<br>
				  <input type="text" name="fullname" value="Your Name"><br>

				  Event name:<br>
				  <input type="text" name="eventname" value="Your event name"><br>

				  Event date:<br>
				  <input type="date" name="eventdate"><br>
				  
				  Event description:<br>
				  <textarea rows="4" cols="50" name="eventdesc" form="event_form">Your event info here...</textarea><br>

				  Event location:<br>
				  <input type="text" name="eventloc" value="City, State"><br><br>
				  <input type="submit" value="Submit">
			</form>
		</div>
